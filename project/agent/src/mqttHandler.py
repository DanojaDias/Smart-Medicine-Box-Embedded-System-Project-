...
def on_message(mqttClient, userdata, msg):
    	...
    	phone.starts()
        noOfArgs=phone.split1(str(msg.payload))
        if noOfArgs==11:
            phone.callInsertData(str(msg.payload))

        else :
            phone.addRemove(str(msg.payload))
            phone.close()
...
def main():
    ...
    TOPIC_TO_SUBSCRIBE = "from/android"
    global TOPIC_TO_PUBLISH
    TOPIC_TO_PUBLISH = "to/android"
